 ...
 **                           for Emacs...
 ** Local Variables: ;;
 ** compile-command: "cd $REFPERSYS_TOPDIR && make plugins_dir/rpsplug_createnamedattribute.so && /bin/ln -sfv $(/bin/pwd)/plugins_dir/rpsplug_createnamedattribute.so /tmp/" ;;
 ** End: ;;
 ****************/
