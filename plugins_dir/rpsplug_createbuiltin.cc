...
// passed to commits after f09767d6fcb6 (in december 2025) of RefPerSys
// GPLv3+ licensed
// © Copyright 2025 Basile Starynkevitch <basile@starynkevitch.net>

// This plugin rpsplug_createbuiltin installs a builtin REPL
// "functional" operator
/*****
 * Once compiled, use it for example as:
 * ./refpersys --plugin-after-load=/tmp/rpsplug_createbuiltin.so \
 *             --plugin-arg=rpsplug_createbuiltin:make_set \
 *             --batch --dump=.
 *
 ****/
...
#warning rpsplug_createbuiltin.cc needs review and improvement
void
