...
extern "C" const char rps_values_basename[];
const char rps_values_basename[]= RPS_BASENAME;

extern "C" const char rps_values_baseid[];
const char rps_values_baseid[]= RPS_BASEID;
