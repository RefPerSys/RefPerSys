...
# file RefPerSys/test_dir/008otherscript.bash
...
echo running refpersys -AREPL --script=$0 --user-pref=. --batch --run-name=008otherscript

./refpersys -AREPL --script=$0 --user-pref=. --batch --run-name=008otherscript
exit $?

## for GDB use
## gdb --args ./refpersys -AREPL --script=test_dir/008otherscript.bash --user-pref=. --batch --run-name 008otherscript
...
## for Emacs:
## Local Variables: ;;
## compile-command: "cd $REFPERSYS_TOPDIR && test_dir/008otherscript.bash" ;;
## End: ;;
# end of file RefPerSys/test_dir/008otherscript.bash
