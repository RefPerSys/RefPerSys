...
#    it is testing the readline interface added in august 2026.
#
...
/usr/bin/gmake plugins_dir/rpsiplug_fox.so
...
./refpersys --run-name=014foxplug -AREPL -dEVLOOP \
	    --interactive-plugin=plugins_dir/rpsiplug_fox.so \
	    --run-delay=25s --locale=C.UTF-8 $*

##
##**************
##                           for Emacs...
## Local Variables: ;;
## compile-command: "cd $REFPERSYS_TOPDIR && make test14" ;;
## End: ;;
##**************/
