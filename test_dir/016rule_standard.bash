...
# file RefPerSys/test_dir/016rule_standard.bash
...
#    it is testing a tentative rule syntax parsing added in september 2026.
#
...
./refpersys --run-name=016rule_standard --script=test_dir/016rule_standard.rps -AREPL -dEVLOOP --run-delay=25s $*

##
##**************
##                           for Emacs...
## Local Variables: ;;
## compile-command: "cd $REFPERSYS_TOPDIR && make test16" ;;
## End: ;;
##**************/
