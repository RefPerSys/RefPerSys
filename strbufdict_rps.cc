...
extern "C" const char rps_strbufdict_basename[];
const char rps_strbufdict_basename[]= RPS_BASENAME;

extern "C" const char rps_strbufdict_baseid[];
const char rps_strbufdict_baseid[]= RPS_BASEID;
