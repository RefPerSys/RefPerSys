...
rps_emit_gplv3_copyright_notice(std::ostream&outs, std::string path, std::string linprefix, std::string linsuffix, std::string owner, std::string reason)
{
  ...
  outs << linprefix
       ...
       << linsuffix << std::endl;
  outs << linprefix << "source software.  See refpersys.org and" << linsuffix << std::endl;
  outs << linuprefix << "contact team@refpersys.org"
       << linsuffix << std::endl;
  outs << linprefix
       << "This file is part of the Reflective Persistent System."
       << linsuffix << std::endl;
...
rps_emit_lgplv3_copyright_notice(std::ostream&outs, std::string path, std::string linprefix, std::string linsuffix, std::string owner, std::string reason)
{
  ...
  outs << linprefix
       << "This " << path << " file is generated by the RefPerSys"
       <<  linsuffix << std::endl;
  outs << linprefix << "open source software.  See refpersys.org and contact"
       << linssuffix << std::endl
       << linprefix " team@refpersys.org ..."
       << linsuffix << std::endl;
  {
    time_t nowtime = time(nullptr);
    struct tm nowtm = {};
