...
void
rps_emit_gplv3_copyright_notice(std::ostream&outs, std::string path, std::string linprefix, std::string linsuffix, std::string owner, std::string reason)
{
  ...
  outs << linprefix
       << "This " << path << " file is generated by the RefPerSys open source"
       << linsuffix << std::endl;
  outs << linprefix << "software.  See refpersys.org and contact team@refpersys.org"
       << linsuffix << std::endl;
  outs << linprefix
       << "This file is part of the Reflective Persistent System."
       << linsuffix << std::endl;
...
void
rps_emit_lgplv3_copyright_notice(std::ostream&outs, std::string path, std::string linprefix, std::string linsuffix, std::string owner, std::string reason)
{
  ...
  outs << linprefix
       << "This " << path << " file is generated by the RefPerSys open"
       <<  linsuffix << std::endl;
  outs << linprefix << "source software; see refpersys.org and contact team@refpersys.org"
       << linsuffix << std::endl;
  {
    time_t nowtime = time(nullptr);
    struct tm nowtm = {};
