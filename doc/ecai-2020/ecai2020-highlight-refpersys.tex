...
leaving office at evening. Having these files in a textual format
facilitates their management with existing distributed version control
systems such as \href{http://git-scm.com}{\texttt{git}} or software
development forges like \href{http://gitlab.com/}{\texttt{gitlab}} and
ensures some data portability. Carefully generating the runtime, through
metaprogramming approaches, as \emph{C++} code (à la \textsc{Gcc Melt}
...
such a code base takes hours of computer time.}, and this entire heap
%%
