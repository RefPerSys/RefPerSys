...
the computer memory. This large graph should be orthogonally persistent
\cite{Dearle:2010:orthopersist} (such as in the \textsc{Bismon}
\cite{Starynkevitch:2019:bismon-draft} system) on disk, and be loaded from
