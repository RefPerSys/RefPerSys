...
\subsection{\textsc{RefPerSys} core idea[l]s}
\label{subsec:coreidea}

The title of this subsection is not a typo. We indeed mean both ideas
and ideals.
...
feature (first entirely hand-written, later more and more parts of it
