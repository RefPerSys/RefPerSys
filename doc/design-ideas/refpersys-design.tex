...
\begin {figure} [h]
  ...
  \begin {center}
    \begin {tabular} {l c l l}
      ...
      & $|$ & \emph {\textbf {object}} 
	& mutable \emph {\textbf {value}} with unique object ID \\
      & $|$ & \emph {\textbf {set}}
	& set of unordered unique \emph {\textbf {object}}s \\
      & $|$ & \emph {\textbf {tuple}}
  ...
  \begin {center}
    \begin {tabular} {l c l l}
      \emph {\textbf {int}} & $\leftarrow$ & $\mathbb {Z}$
        & an integer represented as an HJSON number type
    \end {tabular}
  \end {center}

  \begin {center}
    \begin {tabular} {l c l l}
      \emph {\textbf {float}} & $\leftarrow$ & $\mathbb {R}$
        & a real number represented as an HJSON number type
    \end {tabular}
  \end {center}

  \begin {center}
    \begin {tabular} {l c l l}
      \emph {\textbf {string}} & $\leftarrow$ 
	& \texttt {"}\alpha\texttt {"}, \alpha \subseteq \{Unicode\}
  ...
  \begin {center}
    \begin {tabular} {l c l l}
      \emph {\textbf {object}} & $\leftarrow$ 
	& \_\alpha, \alpha \subseteq \{Base-62\}
        & a Base-62 number prefixed with an underscore
    \end {tabular}
  \end {center}

  \caption {Syntax of Values}
\end {figure}
