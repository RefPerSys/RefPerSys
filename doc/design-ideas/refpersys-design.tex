...
\newglossaryentry{AGI}
{
    ...
    description={
        Artificial general intelligence refers to the specific capacity of a machine 
	to learn and understand any intellectual task that can be performed by a 
	human being. It is the primary goal of artificial intelligence research, 
	and is sometimes referred to as ``strong AI'' or ``full AI''
    }
}
\newglossaryentry{meta-knowledge}
{
    name=meta-knowledge,
    description={
        Meta-knowedge is knowledge about knowledge, and is an inclusive term
	...
	meta-knowledge. Even the tagging of documents could be considered as
	meta-knowledge. In AGI, meta-knowledge refers to the knowledge about
...
knows'' and, interestingly enough, relates to both \gls{meta-knowledge} and
