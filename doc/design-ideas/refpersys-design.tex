...
The \textbf{persistence} machinery is conceptually simple: start from
global roots and travers the memory graph but ignore transient objects
and memoize previously seen objects. Of course, objects should not be
persisted twice, and are referred by the \textbf{object id} or
