...
particular {\RefPerSys} object. The figure \ref{fig:inheritance} shows
the single-inheritance graph of {\RefPerSys} values.
...
\begin{figure}[h]
  ...
  \caption{The %
    ...
    inheritance graph in \RefPerSys : $a \rightarrow b \equiv a \mathrm{is an instance of} b$}
