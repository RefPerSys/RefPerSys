...
%   \smallskip
 ...
 \begin{frame}{Les valeurs composites dans RefPerSys}
   ...
   \begin{relsize}{-0.5}
   Attention à notre terminologie: une instance n'est pas un objet
   (car immuable) mais toutes les valeurs composites ont leur classe
   et leur type. Les instances pourraient être utiles pour représenter
   des n{\oe}uds d'une syntaxe ou des faits, etc...
   \end{relsize}
 \end{frame}
