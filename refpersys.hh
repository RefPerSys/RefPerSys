...
// generated in _timestamp.c
extern "C" const char rpside_timestamp[];
extern "C" unsigned long rpside_timelong;
extern "C" const char rpside_directory[];
extern "C" const char rps_directory[];
extern "C" const char rpside_gitid[];
extern "C" const char rpside_lastgittag[];
extern "C" const char rpside_lastgitcommit[];
extern "C" const char rpside_md5sum[];
extern "C" const char rpside_makefile[];
...
extern void rps_print_types_info(void);
...
std::string rps_read_file_as_string(const std::string &fileName);
...
static inline bool rps_is_type_of_scalar_quasi_value(const Rps_Type ty);
...
////////////////////////////////////////////////////////////////
//// The objid support is in a separate file. Because it would be shared
//// with our rps_make_const metaprogram.
#include "oid_rps.hh"
////////////////////////////////////////////////////////////////
